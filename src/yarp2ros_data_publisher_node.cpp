...
int main(int argc, char *argv[]) 
{
    ...
    while(nh.ok())
    {
    	...
    	// get the arms force torque measurements
    	yarpDataPub.get_arms_force_torque_values();
    	yarpDataPub.get_feet_force_torque_values();

    	// publish the data from the measurement
    	yarpDataPub.publish_arms_force_torque_measurements();
    	yarpDataPub.publish_feet_force_torque_measurements();
